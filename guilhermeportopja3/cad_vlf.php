...
$email=$_POST['email'];
$senha=$_POST['senha'];
$cad_vlf="insert into volfisico(nome,cpf,telefone,email,senha) values ('$nome','$cpf','$telefone','$email','$senha')";
$con=mysqli_connect("127.0.0.1","root","","fourwheels");
	if(mysqli_connect_errno())
		{echo "Failed to connect to MySql:".mysqli_connect_error();}
	mysqli_query($con,$cad_vlf);
	mysqli_close($con);	
?>
...
<html lang="en">
  ...
  <body>
	...
	<div class="jumbotron jumbotron-fluid bg-with">
	  <div class="container">
	  <center>
		<h6 class="display-4">Voluntário Físico Cadastrado Com Sucesso!</h6>
		<hr widht="40%">
		<p class="lead">	
	  </div>
	</div>
