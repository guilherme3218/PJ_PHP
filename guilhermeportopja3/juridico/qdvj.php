...
<div class="jumbotron jumbotron-fluid bg-with">
  ...
  <center>
	...
	<ul>		
		<a href="srvj.php" class="btn btn-outline-dark" role="button" aria-pressed="true">Serviço</a>
		<a href="pcvj.php" class="btn btn-outline-dark" role="button" aria-pressed="true">Peças</a>
		<!-- (Serviços) irá registrar quantidade e o tipo de serviço oferecido -->
		<!-- (Peças) irá registrar o nome da peça e sua descrição -->
		<!-- (itemPeça) quantidade de peça id da doação  e o id da peça-->	
		<!-- (doação) quantidade de serviços id serv e os ids dos vuluntarios-->
	</ul>
	</center>
  </div>
