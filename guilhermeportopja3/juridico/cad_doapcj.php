...
$cad_doapc="insert into peca(nome,descricao) values ('$nome','$descricao')";

$con=mysqli_connect("127.0.0.1","root","","fourwheels");
	if(mysqli_connect_errno())
		{echo "Failed to connect to MySql:".mysqli_connect_error();}
	mysqli_query($con,$cad_doapc);
	mysqli_close($con);	
?>
...
<html lang="en">
  <head>
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ">
			  <li class="nav-item active">
				<a class="nav-link" href="homevj.pjp">Four Wheels  <span class="sr-only">(current)</span></a>
			  </li>
			  <li class="nav-item">
	...
	<div class="jumbotron jumbotron-fluid bg-with">
	  <div class="container">
		<center>
			<h6 class="display-4">Doação Realiazada com  Sucesso!</h6>
			<hr widht="40%">
			<p class="lead">	
	  </div>
	</div>
