	  ...
	  <!-- Menu Superior -->
	   <nav class="navbar navbar-expand-lg navbar-light bg-light  ">
		...
		<div class="btn-group ml-auto">
		  <button type="button" class="btn btn-warning mr-auto ml-auto" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			LOGAR
		  </button>
		  <div class="dropdown-menu">
			<a class="dropdown-item btn btn-dark" href="fisico/lgvf.php">Físico</a>
			<a class="dropdown-item btn btn-dark" href="juridico/lgvj.php">Jurídico</a>
		  </div>	
	  </div>
	</nav>
